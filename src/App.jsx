...
const PROFILES = [
  ...
  { id: 11, name: "Tigrou", species: "cat", breed: "British Shorthair", age: "5 ans", gender: "M", energy: 3, temper: ["Indépendant", "Posé", "Joueur"], distance: "2,0 km", vaccinated: true, sterilized: true, owner: "Olivier F.", bio: "Tigrou a un faux air bougon avec sa bouille toute ronde, mais c'est un grand tendre une fois la confiance installée. Indépendant sans être distant, il apprécie la compagnie sur ses propres conditions. Cherche un copain de jeu qui respecte son rythme.", seeking: ["Play date", "Compagnon de vie"], emoji: "🐱", color: "#B8B8C9", photos: ["https://cataas.com/cat?width=500&height=500&t=16", "https://cataas.com/cat?width=500&height=500&t=17", "https://cataas.com/cat?width=500&height=500&t=18"], lat: 48.847, lng: 2.352, pedigree: false },
