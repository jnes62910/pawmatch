...
const PROFILES = [
  ...
  { id: 3, name: "Mochi", species: "cat", breed: "Européen", age: "5 ans", gender: "M", energy: 2, temper: ["Posé", "Affectueux", "Indépendant"], distance: "2,1 km", vaccinated: true, sterilized: true, owner: "Clara B.", bio: "Mochi est un grand gaillard au caractère doux qui préfère les siestes au soleil aux courses-poursuites. Affectueux sans être collant, il cherche un compagnon tranquille pour partager le canapé — l'idéal serait un chat aussi zen que lui.", seeking: ["Compagnon de vie", "Play date"], emoji: "🐱", color: "#C9B8A9", photos: ["https://cataas.com/cat?width=500&height=500&t=4", "https://cataas.com/cat?width=500&height=500&t=5", "https://cataas.com/cat?width=500&height=500&t=6"], lat: 48.828, lng: 2.370, pedigree: true },
  ...
  { id: 5, name: "Pixel", species: "cat", breed: "Européen", age: "2 ans", gender: "F", energy: 4, temper: ["Bavarde", "Curieuse", "Vive"], distance: "0,5 km", vaccinated: true, sterilized: true, owner: "Léa P.", bio: "Pixel ne tient jamais en place et a un avis sur tout (elle vous le fera savoir, miaulements à l'appui). Très curieuse, elle adore explorer chaque recoin et cherche une amie aussi vive qu'elle pour des sessions de jeu mémorables.", seeking: ["Play date", "Cat date"], emoji: "🐱", color: "#A9B8C9", photos: ["https://cataas.com/cat?width=500&height=500&t=7", "https://cataas.com/cat?width=500&height=500&t=8", "https://cataas.com/cat?width=500&height=500&t=9"], lat: 48.836, lng: 2.355, pedigree: false },
];
