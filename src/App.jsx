...
const REPRO_PROFILES = [
  ...
  { id: 17, name: "Bella", species: "dog", breed: "Cavalier King Charles", age: "2 ans", gender: "F", emoji: "🐕", owner: "Marion S.", distance: "4,7 km", vaccinated: true, pedigree: true, testedGenes: true, price: "550 €", bio: "Bella recherche un mâle avec pedigree pour une première portée. Cœur testé sain, caractère très doux.", temper: ["Douce", "Câline"], color: "#E8C9B8", photos: ["/photos/bella-repro-1.jpg"] },
