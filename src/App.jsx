...
const FAQ_ITEMS = [
  ...
  { q: "Comment fonctionne la géolocalisation ?", a: "Vous pouvez activer le partage de votre position depuis l'onglet Prestataires (et depuis la recherche avancée en Reproduction) pour affiner les résultats selon votre distance réelle. Seule une distance approximative est visible par les autres utilisateurs — jamais votre adresse exacte. Vous pouvez désactiver le partage à tout moment, à l'endroit même où vous l'avez activé." },
];
